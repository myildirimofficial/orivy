...
## Next steps and examples to add

- Add runnable, copy-paste examples into `Orivy.Test` demonstrating common patterns (Docked master/detail, anchored resize, AutoSize wrapping text). I can add these examples and the demo pages if you want.

---

If you'd like, I will now add runnable examples to `Orivy.Test` and run a DocFX doc build to validate links. Which should I do next: add examples or run a docs check?
