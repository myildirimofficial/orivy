...
public partial class TabView : ElementBase
{
    ...
    internal override void OnMouseMove(MouseEventArgs e)
    {
        ...
        // Chevron hover state — only register hover when the chevron is
    ...
    private void DrawTabStrip(SKCanvas canvas)
    {
        ...
        // disappears, giving the edge tab full visibility — no more
    ...
    private bool TryGetTabIndexAtPoint(SKPoint point, out int tabIndex)
    {
        ...
        // In horizontal scroll mode, the chevron zones are exclusive —
    ...
    private void UpdateTabRects()
    {
        ...
        if (UsesVerticalTabLayout)
        {
            // Vertical layout (unchanged) – no scroll mode for vertical
        ...
        else // Scroll mode
        {
            ...
            // Compute chevron button positions — only when needed.
            if (needsChevrons)
            {
